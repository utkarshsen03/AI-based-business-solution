...
class Model:
    ...
    def generate(self, user_query):
        if not user_query.strip():
            return "I am an AI Assistant to help you with toolkit. How may I assist you today?"
        
        custom_prompt = f"""Introduction/Goal
...
You're welcome! I'm glad I could help. If you ever need more insights, feel free to ask. Wishing you continued success with your business!
            ...
            AI Assistant:
            """
        output = self.model.generate_content(custom_prompt)
        return output.text
...
@app.route("/")
def home():
    default_response = "I am an AI Assistant to help you with toolkit. How may I assist you today?"
    return render_template("chat.html",default_response=default_response)
